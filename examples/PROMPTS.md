...
- Visual references: the user's attached AI composition (not republished), [official character-announcement lineup](https://yanisuu.com/news/post-100), [official Tayama standing image](https://yanisuu.com/assets/img/character/chara2/stand.webp?ver=1.41), and [`../skills/card-creator/assets/logo-references/overseas/japan/suica.png`](../skills/card-creator/assets/logo-references/overseas/japan/suica.png). The official and user images were temporary references, not copied into the repository.
- This replaces the earlier version that gave both identities long dangling earrings and made their smiles too similar. The first generated result includes a contextual `従業員専用` sign; the user chose to retain that version, so a later text-removal test was discarded.

```text
Use case: stylized-concept. Asset type: ONE finished downloadable card-face illustration for a nonofficial anime fan-art gallery. Input image 1 is the user's square character reference showing Yamada (left) and Tayama (right): use it ONLY for their facial identities, expressions, hair, clothing and the warm-versus-cool two-state concept; do NOT reproduce its page layout, inset headshots, tiny full-body cutouts, AI warning, borders or text. Input image 2 is an official anime lineup that confirms the two contrasting looks. Input image 3 is Tayama's official anime standee for her restrained eye expression, hairstyle, choker, jacket and ear details. Input image 4 is the Suica wordmark reference, not a layer to paste. Create a NEW horizontal flat opaque edge-to-edge card image around 1.586:1. Exactly TWO prominent depictions of the SAME adult woman, one on each side of a subtle organic light divide, with coherent face shape and auburn hair: LEFT, Yamada during work inside a warmly lit supermarket, pale yellow button-up shirt under a brick-red apron, neat short side-parted bob held with discreet hair clips, no visible earrings, eyes closed in an open, genuinely cheerful welcoming smile (not seductive or sleepy), hands simply folded at her waist. RIGHT, Tayama after work in a quiet blue-night space behind the supermarket, straight blunt-fringe auburn bob gathered low, short black choker, black leather jacket over a simple white dress, one relaxed hand holding a cigarette, direct composed open-eyed gaze and a tiny understated knowing smile (not half-lidded or sultry). Her ear details, if visible, are tiny subtle piercings/studs; absolutely no long dangling gold-bar earrings on either side. Sophisticated 2D anime illustration, elegant restrained drawing, warm ivory/brick red against deep midnight blue, subject faces immediately readable at card thumbnail size. The left and right portrayals should feel like two moods of one person, not two different women. Add one modest legible 'Suica' wordmark at lower-right as an artistic style-matched interpretation. ONLY text is 'Suica'. No male character, no inset portraits, no duplicate mini figures, no card number, chips, QR, contactless/NFC icon, extra words, watermark, warning label, frame, drop shadow, physical card mockup, rounded-corner mask, white or transparent margins. Image model generates all elements together, no pasted logo.
```
...
- Output: [`anime-steel-ball-run-johnny-gyro.png`](anime-steel-ball-run-johnny-gyro.png)
- Featured icon version: [`anime-steel-ball-run-johnny-gyro-amex.png`](anime-steel-ball-run-johnny-gyro-amex.png), made by editing the original card in the image-generation tool with the repository's `payment/american-express.png` picture as a **visual reference only**.
- Character references: [Johnny Joestar](https://jojo-portal.com/anime/sbr/character/01/) and [Gyro Zeppeli](https://jojo-portal.com/anime/sbr/character/02/) official anime character visuals. Their downloaded PNGs were temporary image-generation references, not included in this repository.

```text
Use case: stylized-concept. Asset type: a finished collectible landscape card-face illustration for a nonofficial JoJo's Bizarre Adventure: Steel Ball Run fan-art gallery. Input images: Image 1 is the OFFICIAL Johnny Joestar anime character-identity and outfit reference. Image 2 is the OFFICIAL Gyro Zeppeli anime character-identity and outfit reference. Use their recognizable faces, hair, hats, costume color/details; create a wholly new scene and poses, do not paste the standing reference art or copy a poster. Scene/backdrop: a vast sunlit American desert race course with distant mesas and a few dust trails; a subtle graphic golden-spiral motif flowing across the landscape evokes Gyro's Spin. Subject: Johnny Joestar in his pale star-patterned riding cap, light top and deep blue lower costume riding Slow Dancer; Gyro Zeppeli in wide-brimmed hat with metal plates, flowing blond hair, violet top and olive cape riding Valkyrie. They race together as two equal co-leads, focused and charismatic, with one small polished steel ball glinting near Gyro's hand. Style/medium: luxurious hand-drawn anime key art meets editorial art-print design, clean assertive contour lines, refined cel shading, a little halftone texture and metallic-gold dust highlights. Not photorealistic and not chibi. Composition: flat, fully opaque, edge-to-edge landscape card face at about 1.586:1. Energetic diagonal movement from lower-left foreground to upper-right distance; both characters visible from waist up on their horses, horses' heads and front portions legible, no crowded cut-off faces. Balanced readable hierarchy at small card size, with heroic poses and uncluttered spatial depth. No rounded-corner mask, no border, no mockup. Palette/light: warm sandstone, sky cyan, ultramarine, violet and restrained brass-gold; vivid daylight, adventurous and stylish rather than gloomy. Constraints: Faithful identifiable anime character features based on references, one Johnny and one Gyro only, correct number of limbs/fingers, naturally plausible horseback posture and horse anatomy. No bank, payment or transit logos; no series title, no typography, no numbers, no chip, no QR, no NFC/contactless icon, no device, no watermark. Nonofficial fan-art interpretation.
```

Final icon edit (input 1: the unmarked card; input 2: `payment/american-express.png` visual reference):

```text
Use case: precise-object-edit. Asset type: final nonofficial collectible card-face artwork. Image 1 is the EXISTING Steel Ball Run card-face illustration and must remain the edit target. Image 2 is an American Express mark reference for visual identity only, not a pasted layer. Add exactly one readable AMERICAN EXPRESS two-line brand mark to the clear upper-right sky area of Image 1, integrated as an elegantly drawn antique brass-and-ivory travel-card insignia that complements the desert race palette, large enough to read at card thumbnail size but not covering the golden spiral or a character. Spell the words exactly 'AMERICAN EXPRESS'. Preserve the entire original Johnny and Gyro duo, horses, poses, anatomy, colors, desert mesas, dust, golden spiral and all composition outside the new mark. The finished image remains a flat opaque edge-to-edge landscape card face around 1.586:1, not a mockup. No other text, payment icon, chips, card numbers, QR, NFC/contactless, extra logo, frame, corner mask or watermark. This is a style-matched nonofficial reinterpretation, not a licensed American Express card or exact brand-standard reproduction.
```

### 石之海 · 乔伦

- Output: [`anime-stone-ocean-jolyne.png`](anime-stone-ocean-jolyne.png)
- Featured icon version: [`anime-stone-ocean-jolyne-sunpass.png`](anime-stone-ocean-jolyne-sunpass.png), made by editing the original card in the image-generation tool; the official SunPass site and form were used to verify the Florida identity and logo concept, with no downloaded SunPass image embedded or included in this repository.
- Character reference: [Jolyne Cujoh](https://jojo-portal.com/anime/so/character/01/) official anime character visual. The downloaded PNG was a temporary image-generation reference, not included in this repository.

```text
Use case: stylized-concept. Asset type: a finished collectible landscape card-face illustration for a nonofficial JoJo's Bizarre Adventure: Stone Ocean fan-art gallery. Input image: the official anime Jolyne Cujoh character-identity and outfit reference. Preserve her recognizable green-and-blond double-bun hairstyle, face, dark teal/sea-green spiderweb-patterned outfit and butterfly emblem; create a wholly new pose and setting, do not paste or trace the standing reference art or an existing poster. Scene/backdrop: Jolyne stands confidently at the edge of an abstract prison corridor opening onto luminous ocean sky, turning pale, elegantly flowing Stone Free threads into a sweeping ribbon composition that breaks the rhythm of prison bars; a few graphic butterfly silhouettes signal freedom. Subject: Jolyne alone, energetic and defiant, one anatomically plausible hand controlling the threads, face and butterfly emblem clearly legible. Style/medium: bold high-fashion JoJo manga editorial art, luxurious ink contour lines, nuanced cel-shading, subtle screenprint grain, prismatic stained-glass color planes, not photorealistic and not chibi. Composition: flat, fully opaque, edge-to-edge landscape card face at about 1.586:1; Jolyne large but not cramped, off-center on the right, threads arc dynamically across the left, clear face and hands, no crowded cut-off anatomy, balanced readable hierarchy at small card size. No rounded-corner mask, no border, no mockup. Palette/light: saturated emerald, turquoise, midnight violet and electric magenta, luminous seafoam and warm sunset highlights; vivid and liberating, not muddy or gloomy. Constraints: faithful identifiable anime character details based on reference, only one Jolyne, correct number of limbs and fingers, no other characters. No bank, payment or transit logos; no series title, no typography, no numbers, no chip, no QR, no NFC/contactless icon, no device, no watermark. Nonofficial fan-art interpretation.
```

Final icon edit (input: the unmarked card):

```text
Use case: precise-object-edit. Asset type: final nonofficial collectible card-face artwork. Image 1 is the EXISTING Stone Ocean Jolyne card-face illustration and must remain the edit target. Add exactly ONE visible, correctly spelled 'SunPass' wordmark inspired by Florida's SunPass prepaid toll program to the dark open area in the upper-left corner. Make it a refined mint/seafoam-and-warm-sunset-gold badge, with a simple stylized rising-sun / receding-road motif and the readable word 'SunPass', in harmony with the emerald and purple manga illustration; moderately sized like a real card-face brand anchor, comfortably inset from the edge. Do not add 'Prepaid Toll Program' or other text. This is an AI-painted, nonofficial style-matched interpretation, NOT an exact licensed service logo or a claim of toll-payment capability. Preserve Jolyne's face, double-bun hair, butterfly chest emblem, outfit, anatomical hands, thread ribbons, butterflies, dramatic prison bars, ocean sunrise, colors and overall original composition. Keep the flat fully opaque edge-to-edge landscape 1.586:1 artwork, not a mockup. No other words or logos, card numbers, chip, QR, NFC/contactless symbol, border, rounded-corner mask, device or watermark.
```
