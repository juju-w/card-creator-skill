...
export const works = [
  ...
  { id: "chatgpt-gardevoir-cmb-unionpay", title: "超能系粉色", subtitle: "沙奈朵 × 招商银行 × 银联", series: ["pokemon", "anime"], image: "chatgpt-gardevoir-cmb-unionpay.png", origin: "用户分享的 ChatGPT 网页成图；无法确认当时是否加载了 Skill。", prompt: "使用 [juju-w/card-creator-skill](https://github.com/juju-w/card-creator-skill) card-creator Skill @创建图像 ，生成一张宝可梦里沙奈朵的卡面，简洁，超能系粉色， 招商银行银联信用卡，不要芯片" },
  { id: "chatgpt-metagross-icbc-mastercard-world", title: "青色云母金属", subtitle: "巨金怪 × 工商银行 × Mastercard", series: ["pokemon", "anime"], image: "chatgpt-metagross-icbc-mastercard-world.png", origin: "用户分享的 ChatGPT 网页成图；原始 Prompt 中的 word 保持原样，无法确认当时是否加载了 Skill。", prompt: "@创建图像 使用 [juju-w/card-creator-skill](https://github.com/juju-w/card-creator-skill) card-creator Skill  ，生成一张宝可梦里巨金怪的万事达 word 卡面，工商银行，不要芯片，万事达logo 不要颜色只保留线条，整体有云母/金属光泽，保持青色系" },
  { id: "gemini-magikarp-icoca", title: "水边的鲤鱼王", subtitle: "简洁海蓝 × ICOCA", series: ["pokemon", "anime"], image: "gemini-magikarp-icoca.jpeg", origin: "用户分享的 Gemini 成图；标志为生成图里的非官方诠释。", prompt: "使用 card-creator Skill，生成一张鲤鱼王 × ICOCA 卡面：简洁，右下角 ICOCA。" },
  { id: "gemini-gengar-octopus", title: "紫色耿鬼", subtitle: "夜色科技 × 八达通", series: ["pokemon", "anime"], image: "gemini-gengar-octopus.jpeg", origin: "用户分享的 Gemini 成图；紫色标志为生成图里的非官方诠释。", prompt: "使用 card-creator Skill，生成一张耿鬼 × 八达通卡面，让八达通 Logo 变成与画面匹配的紫色。" },
  ...
  { id: "huashan-ink-tunion", title: "华山水墨", subtitle: "山水留白 × 交通联合", series: ["city", "art"], image: "huashan-ink-tunion.png", prompt: "使用 card-creator Skill，生成一张华山水墨画风格的交通卡面，右下角交通联合。" },
