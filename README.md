...
下面是一次完整工作流：ImageGen 只生成清新水彩背景，`card-creator` 再将清单中
`status: ready` 的 Suica 透明贴纸确定性叠加到安全区内。成品没有卡号、二维码或无关文字。

![非官方 Chiikawa × Suica 卡面示例](examples/chiikawa-suica.png)

> 非官方、非商业同人示例，仅用于演示 Skill 的卡面构图与贴纸合成能力；不代表角色或交通卡权利方授权、合作或认可。
